...
async def lifespan(app: FastAPI):
    ...
    # Auto-seed initial demo sessions if store is empty
    session_service.seed_initial_data()
...
from app.api import arbitrator, alice, bob, security, attacks, sessions, engine_routes, database_explorer
...
app.include_router(database_explorer.router, prefix=settings.API_PREFIX)
